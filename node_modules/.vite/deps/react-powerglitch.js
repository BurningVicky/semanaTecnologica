...
var f = (e, t, i) => t in e ? w(e, t, { enumerable: true, configurable: true, writable: true, value: i }) : e[t] = i;
var u = (e, t) => {
  for (var i in t || (t = {}))
...
var S = (e, t) => G(e, M(t));
var y = (e = "always") => ({ playMode: e, optimizeSeo: true, createContainers: true, hideOverflow: false, timing: e === "always" ? { duration: 2 * 1e3, iterations: 1 / 0 } : { duration: 250, iterations: 1 }, glitchTimeSpan: e === "always" ? { start: 0.5, end: 0.7 } : { start: 0, end: 1 }, shake: { velocity: 15, amplitudeX: 0.2, amplitudeY: 0.2 }, slice: e === "click" ? { count: 15, velocity: 20, minHeight: 0.02, maxHeight: 0.15, hueRotate: true } : { count: 6, velocity: 15, minHeight: 0.02, maxHeight: 0.15, hueRotate: true }, pulse: false });
var v = (e, t) => {
  if (!e.glitchTimeSpan)
    return 1;
...
var m = (e, t) => (Math.random() - 0.5) * 2 * v(e, t);
var C = ({ minHeight: e, maxHeight: t, minWidth: i, maxWidth: r }) => {
...
var A = (e) => e.pulse ? { steps: [{ transform: "scale(1)", opacity: "1" }, { transform: `scale(${e.pulse.scale})`, opacity: "0" }], timing: S(u({}, e.timing), { delay: (e.glitchTimeSpan ? e.glitchTimeSpan.start : 0) * e.timing.duration, easing: "ease-in-out" }) } : null;
var x = (e) => {
  if (!e.shake)
    return { steps: [], timing: {} };
...
var b = (e) => [x(e), A(e), ...Array.from({ length: e.slice.count }).map(() => H(e))].filter((t) => t !== null);
var $ = (...e) => {
...
var L = { glitch: T, generateLayers: b, getDefaultOptions: y };
function W(e) {
  const [t, i] = (0, import_react.useState)(e), [r, n] = (0, import_react.useState)(() => () => {
  }), [o, a] = (0, import_react.useState)(() => () => {
  });
  return {
    ref: (0, import_react.useCallback)((c) => {
      if (!c)
        return;
